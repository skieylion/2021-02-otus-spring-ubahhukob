...
insert into GENRE (ID,NAME) values (4, 'Классика');
insert into GENRE (ID,NAME) values (5, 'Классика');
...
insert into AUTHOR (ID,FULLNAME) values (3, 'Александр Сергеевич Пушкин');
insert into AUTHOR (ID,FULLNAME) values (4, 'Александр Сергеевич Пушкин');
...
insert into BOOK (ID,NAME,AUTHOR_ID,GENRE_ID) values (3, 'Евгений Онегин',3,3);
...
insert into COMMENT (ID,DESCRIPTION,BOOK_ID) values (4, 'Не знаю',1);